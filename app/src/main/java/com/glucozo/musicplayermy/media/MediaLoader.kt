...
import com.ddona.music.model.Favovite
...
class MediaLoader private constructor(private val context: Context) {
    val arrSong = arrayListOf<Song>() //size =0
    val arrFavovite = arrayListOf<Favovite>()
    ...
    private fun loadSong() {
        ...
        Log.d("thaont", "Song size: ${arrSong.size}")
    ...
    private fun loadFavorite() {
        ...
        if (cursor != null) {
            ...
            while (!cursor.isAfterLast) {
                ...
                arrFavovite.add(Favovite(albumID, albumName, albumArt, albumArtist, numofSongs))
        ...
        Log.d("thaont", "albumn size: ${arrSong.size}")
